...
<section class="py-20 bg-gradient-to-r from-black to-blue-900">
    <div class="container px-6 mx-auto text-center">
        ...
        <p class="mb-8 text-lg text-gray-300 md:text-xl">Discover thousands of online courses taught by experts</p>
        <a href="/catalog" class="inline-block px-8 py-3 text-lg font-semibold text-white transition-colors bg-blue-600 rounded hover:bg-blue-700">
            Browse Now
        </a>
    </div>
</section>
...
<?php if (Session::getRole() === 'visitor'): ?>
    <section class="py-20 bg-blue-900">
        <div class="container px-6 mx-auto text-center">
            <h2 class="mb-8 text-3xl font-bold text-white md:text-4xl">Ready to Start Learning?</h2>
            <p class="mb-8 text-lg text-gray-300 md:text-xl">Join thousands of students already learning on Youdemy</p>
            <a href="/signup" class="inline-block px-8 py-3 text-lg font-semibold text-blue-900 transition-colors bg-white rounded hover:bg-gray-300">
                Create Free Account
            </a>
        </div>
    </section>
