<!-- Hero Section -->
<section class="bg-gradient-to-r from-black to-blue-900 py-20">
    <div class="container mx-auto px-6 text-center">
        <h1 class="text-5xl font-bold text-white mb-6">Learn Online with Youdemy</h1>
        <p class="text-xl text-gray-300 mb-8">Discover thousands of online courses taught by experts</p>
        <a class="btn_primary">
            Browse Now
        </a>
    </div>
...
<section class="py-20 bg-gray-900">
    <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold text-white text-center mb-16">Why Choose Youdemy?</h2>
        <div class="grid md:grid-cols-3 gap-12">
            <div class="text-center">
                ...
                <h3 class="text-xl font-semibold text-white mb-4">Interactive Courses</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-semibold text-white mb-4">Learn at Your Own Pace</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-semibold text-white mb-4">Expert Teachers</h3>
